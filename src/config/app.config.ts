...
export const serverConfig: AppConfig = {
  chain: {
    id: BigInt(process.env.NEXT_PUBLIC_CHAIN_ID || "97"),
    idHex: `0x${BigInt(process.env.NEXT_PUBLIC_CHAIN_ID || "97").toString(16)}`,
    name: process.env.NEXT_PUBLIC_CHAIN_NAME || "BNB Testnet",
